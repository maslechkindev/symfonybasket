...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('NWzfBGLBTO', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('2xVKjTqmoq', 0, 'eQ64jXUjCRS3Iavm5VT+Qg', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheClearerService()
    {
        ...
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('RxDSukbtSW', 0, 'eQ64jXUjCRS3Iavm5VT+Qg', (__DIR__.'/pools'), $a));
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('KprJTJoFqB', 0, 'eQ64jXUjCRS3Iavm5VT+Qg', (__DIR__.'/pools'), $a));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'symfonybasket', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'/src/Basket/BasketBundle/Resources/config/doctrine') => 'Basket\\BasketBundle\\Entity', ($this->targetDirs[3].'/src/Product/ProductBundle/Resources/config/doctrine') => 'Product\\ProductBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'Basket\\BasketBundle\\Entity');
        $b->addDriver($a, 'Product\\ProductBundle\\Entity');

        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('BasketBundle' => 'Basket\\BasketBundle\\Entity', 'ProductBundle' => 'Product\\ProductBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_e31a9edfa41f06c11777668f500f96ff333c7e25e65b6a8be56db1157b2db899');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Basket/BasketBundle/Resources/views'), 'Basket');
        $instance->addPath(($this->targetDirs[3].'/src/Product/ProductBundle/Resources/views'), 'Product');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('a95143417ab8b1b74ffe36f2c33a4a50e308821c');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5831cbe4434098.30874074')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'BasketBundle' => 'Basket\\BasketBundle\\BasketBundle',
                'ProductBundle' => 'Product\\ProductBundle\\ProductBundle',
            ...
            'secret' => 'a95143417ab8b1b74ffe36f2c33a4a50e308821c',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => 'a95143417ab8b1b74ffe36f2c33a4a50e308821c',
